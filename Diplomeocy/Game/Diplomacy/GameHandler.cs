...
public class GameHandler {
	...
	public GameHandler StartGame() {
		...
		Board.Territory(Territories.London).IsSupplyPoint = true;
		Board.Territory(Territories.Liverpool).IsSupplyPoint = true;
		Board.Territory(Territories.Edinburgh).IsSupplyPoint = true;
		Board.Territory(Territories.Berlin).IsSupplyPoint = true;
		Board.Territory(Territories.Munich).IsSupplyPoint = true;
		Board.Territory(Territories.Kiel).IsSupplyPoint = true;
		Board.Territory(Territories.Vienna).IsSupplyPoint = true;
		Board.Territory(Territories.Budapest).IsSupplyPoint = true;
		Board.Territory(Territories.Trieste).IsSupplyPoint = true;
		Board.Territory(Territories.Ankara).IsSupplyPoint = true;
		Board.Territory(Territories.Constantinople).IsSupplyPoint = true;
		Board.Territory(Territories.Smyrna).IsSupplyPoint = true;
		Board.Territory(Territories.Paris).IsSupplyPoint = true;
		Board.Territory(Territories.Marseilles).IsSupplyPoint = true;
		Board.Territory(Territories.Brest).IsSupplyPoint = true;
		Board.Territory(Territories.Venice).IsSupplyPoint = true;
		Board.Territory(Territories.Rome).IsSupplyPoint = true;
		Board.Territory(Territories.Naples).IsSupplyPoint = true;
		Board.Territory(Territories.Warsaw).IsSupplyPoint = true;
		Board.Territory(Territories.Moscow).IsSupplyPoint = true;
		Board.Territory(Territories.Sevastopol).IsSupplyPoint = true;
		Board.Territory(Territories.SaintPetersburg).IsSupplyPoint = true;
		...
		Players.Clear(); // yeag I just needed that for testing you know 
