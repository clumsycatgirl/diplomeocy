    ...
    public class CharactersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Characters != null ? 
                          ...
                          Problem("Entity set 'DatabaseContext.Characters'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Path")] Characters characters)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Path")] Characters characters)
        {
            if (id != characters.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DatabaseContext.Characters'  is null.");
            }
            var characters = await _context.Characters.FindAsync(id);
            if (characters != null)
            {
