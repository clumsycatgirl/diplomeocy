...
namespace Web.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdTable,IdUser")] Players players)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdTable,IdUser")] Players players)
        {
            if (id != players.Id)
            {
                return NotFound();
